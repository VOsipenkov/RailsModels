...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { date: @employment.date, employ_id: @employment.employ_id, nameTask: @employment.nameTask, status: @employment.status }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { date: @employment.date, employ_id: @employment.employ_id, nameTask: @employment.nameTask, status: @employment.status }
    assert_redirected_to employment_path(assigns(:employment))
  end
